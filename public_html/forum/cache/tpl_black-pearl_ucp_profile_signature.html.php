...
<tr><td colspan="2" class="row1"><?php echo ((isset($this->_rootref['L_SIGNATURE_EXPLAIN'])) ? $this->_rootref['L_SIGNATURE_EXPLAIN'] : ((isset($user->lang['SIGNATURE_EXPLAIN'])) ? $user->lang['SIGNATURE_EXPLAIN'] : '{ SIGNATURE_EXPLAIN }')); ?></td></tr>
...
<?php if ($this->_rootref['SIGNATURE_PREVIEW']) {  ?>
	...
	<tr><th colspan="2" valign="middle"><?php echo ((isset($this->_rootref['L_SIGNATURE_PREVIEW'])) ? $this->_rootref['L_SIGNATURE_PREVIEW'] : ((isset($user->lang['SIGNATURE_PREVIEW'])) ? $user->lang['SIGNATURE_PREVIEW'] : '{ SIGNATURE_PREVIEW }')); ?></th></tr>
	<tr><td class="row1" colspan="2"><div class="postbody" style="padding: 6px;"><?php echo (isset($this->_rootref['SIGNATURE_PREVIEW'])) ? $this->_rootref['SIGNATURE_PREVIEW'] : ''; ?></div></td></tr>
<?php } ?>


<tr><td class="cat-bottom" colspan="2"><?php echo (isset($this->_rootref['S_HIDDEN_FIELDS'])) ? $this->_rootref['S_HIDDEN_FIELDS'] : ''; ?><input class="btnlite" type="submit" name="preview" value="<?php echo ((isset($this->_rootref['L_PREVIEW'])) ? $this->_rootref['L_PREVIEW'] : ((isset($user->lang['PREVIEW'])) ? $user->lang['PREVIEW'] : '{ PREVIEW }')); ?>" />&nbsp;&nbsp;<input class="btnmain" type="submit" name="submit" value="<?php echo ((isset($this->_rootref['L_SUBMIT'])) ? $this->_rootref['L_SUBMIT'] : ((isset($user->lang['SUBMIT'])) ? $user->lang['SUBMIT'] : '{ SUBMIT }')); ?>" />&nbsp;&nbsp;<input class="btnlite" type="reset" value="<?php echo ((isset($this->_rootref['L_RESET'])) ? $this->_rootref['L_RESET'] : ((isset($user->lang['RESET'])) ? $user->lang['RESET'] : '{ RESET }')); ?>" name="reset" /></td></tr>
</table>
