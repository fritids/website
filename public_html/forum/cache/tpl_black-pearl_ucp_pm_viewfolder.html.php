...
<?php } else { ?>
	...
	<?php }} else { ?>
		...
		<tr><td class="row1" colspan="<?php echo (isset($this->_tpldata['DEFINE']['.']['COLSPAN'])) ? $this->_tpldata['DEFINE']['.']['COLSPAN'] : ''; ?>" height="30" align="center" valign="middle"><span class="gen"><?php echo ((isset($this->_rootref['L_NO_MESSAGES'])) ? $this->_rootref['L_NO_MESSAGES'] : ((isset($user->lang['NO_MESSAGES'])) ? $user->lang['NO_MESSAGES'] : '{ NO_MESSAGES }')); ?></span></td></tr>
	<?php } ?>
