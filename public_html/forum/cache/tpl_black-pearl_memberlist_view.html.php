...
<div id="pagecontent">
	...
	<div><div class="tbl-h-l"><div class="tbl-h-r"><div class="tbl-h-c"><div class="tbl-title"><?php echo ((isset($this->_rootref['L_VIEWING_PROFILE'])) ? $this->_rootref['L_VIEWING_PROFILE'] : ((isset($user->lang['VIEWING_PROFILE'])) ? $user->lang['VIEWING_PROFILE'] : '{ VIEWING_PROFILE }')); ?></div></div></div></div>
	<table class="tablebg" width="100%" cellpadding="0" cellspacing="0">
	<tr><th colspan="2" nowrap="nowrap"><?php echo ((isset($this->_rootref['L_VIEWING_PROFILE'])) ? $this->_rootref['L_VIEWING_PROFILE'] : ((isset($user->lang['VIEWING_PROFILE'])) ? $user->lang['VIEWING_PROFILE'] : '{ VIEWING_PROFILE }')); ?></th></tr>
	<tr>
	...
	<?php if ($this->_rootref['SIGNATURE']) {  ?>
		...
		<tr><td class="cat" colspan="2" align="center"><h4><?php echo ((isset($this->_rootref['L_SIGNATURE'])) ? $this->_rootref['L_SIGNATURE'] : ((isset($user->lang['SIGNATURE'])) ? $user->lang['SIGNATURE'] : '{ SIGNATURE }')); ?></h4></td></tr>
		<tr><td class="row1" colspan="2"><div class="postbody" style="padding:10px;"><?php echo (isset($this->_rootref['SIGNATURE'])) ? $this->_rootref['SIGNATURE'] : ''; ?></div></td></tr>
	<?php } ?>
