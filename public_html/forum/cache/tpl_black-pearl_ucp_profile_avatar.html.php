...
<?php if (! $this->_rootref['S_AVATARS_ENABLED']) {  ?>
	...
	<tr><td class="row3" colspan="2" align="center"><?php echo ((isset($this->_rootref['L_AVATAR_FEATURES_DISABLED'])) ? $this->_rootref['L_AVATAR_FEATURES_DISABLED'] : ((isset($user->lang['AVATAR_FEATURES_DISABLED'])) ? $user->lang['AVATAR_FEATURES_DISABLED'] : '{ AVATAR_FEATURES_DISABLED }')); ?></td></tr>
...
<?php } if ($this->_rootref['S_IN_AVATAR_GALLERY']) {  ?>
	...
	<tr><th colspan="2"><?php echo ((isset($this->_rootref['L_AVATAR_GALLERY'])) ? $this->_rootref['L_AVATAR_GALLERY'] : ((isset($user->lang['AVATAR_GALLERY'])) ? $user->lang['AVATAR_GALLERY'] : '{ AVATAR_GALLERY }')); ?></th></tr>
	<tr>
...
<?php } if ($this->_rootref['S_DISPLAY_GALLERY'] || $this->_rootref['S_IN_AVATAR_GALLERY'] || $this->_rootref['S_LINK_AVATAR'] || $this->_rootref['S_UPLOAD_AVATAR_URL'] || $this->_rootref['S_UPLOAD_AVATAR_FILE'] || $this->_rootref['AVATAR']) {  ?>
	...
	<tr>
		<td class="cat-bottom" colspan="2"><?php echo (isset($this->_rootref['S_HIDDEN_FIELDS'])) ? $this->_rootref['S_HIDDEN_FIELDS'] : ''; ?><input class="btnmain" type="submit" name="submit" value="<?php echo ((isset($this->_rootref['L_SUBMIT'])) ? $this->_rootref['L_SUBMIT'] : ((isset($user->lang['SUBMIT'])) ? $user->lang['SUBMIT'] : '{ SUBMIT }')); ?>" />&nbsp;&nbsp;<?php if ($this->_rootref['S_IN_AVATAR_GALLERY']) {  ?><input class="btnlite" type="submit" name="cancel" value="<?php echo ((isset($this->_rootref['L_CANCEL'])) ? $this->_rootref['L_CANCEL'] : ((isset($user->lang['CANCEL'])) ? $user->lang['CANCEL'] : '{ CANCEL }')); ?>" /><?php } else { ?><input class="btnlite" type="reset" value="<?php echo ((isset($this->_rootref['L_RESET'])) ? $this->_rootref['L_RESET'] : ((isset($user->lang['RESET'])) ? $user->lang['RESET'] : '{ RESET }')); ?>" name="reset" /><?php } ?></td>
	</tr>
<?php } else { ?>
