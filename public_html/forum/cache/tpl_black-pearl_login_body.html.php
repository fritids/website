...
<br />
<div><div class="tbl-h-l"><div class="tbl-h-r"><div class="tbl-h-c"><div class="tbl-title"><?php echo ((isset($this->_rootref['L_LOGIN_CONFIRMATION'])) ? $this->_rootref['L_LOGIN_CONFIRMATION'] : ((isset($user->lang['LOGIN_CONFIRMATION'])) ? $user->lang['LOGIN_CONFIRMATION'] : '{ LOGIN_CONFIRMATION }')); ?></div></div></div></div>
<table class="tablebg" width="100%" cellpadding="0" cellspacing="0">
	<tr><td class="row3" colspan="2"><span class="gensmall"><?php echo ((isset($this->_rootref['L_LOGIN_CONFIRM_EXPLAIN'])) ? $this->_rootref['L_LOGIN_CONFIRM_EXPLAIN'] : ((isset($user->lang['LOGIN_CONFIRM_EXPLAIN'])) ? $user->lang['LOGIN_CONFIRM_EXPLAIN'] : '{ LOGIN_CONFIRM_EXPLAIN }')); ?></span></td></tr>
	<tr><td class="row1" colspan="2" align="center"><input type="hidden" name="confirm_id" value="<?php echo (isset($this->_rootref['CONFIRM_ID'])) ? $this->_rootref['CONFIRM_ID'] : ''; ?>" /><?php echo (isset($this->_rootref['CONFIRM_IMAGE'])) ? $this->_rootref['CONFIRM_IMAGE'] : ''; ?></td></tr>
	<tr>
